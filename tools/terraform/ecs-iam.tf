data "aws_iam_policy_document" "fleet" {
  ...
  statement {
    ...
    resources = [aws_kinesis_firehose_delivery_stream.osquery_results.arn, aws_kinesis_firehose_delivery_stream.osquery_status.arn, aws_kinesis_firehose_delivery_stream.main.arn]
  }
